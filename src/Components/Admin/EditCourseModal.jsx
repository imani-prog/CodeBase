...
const EditCourseModal = ({ showModal, setShowModal, course, onUpdateCourse }) => {
        ...
        <div className="relative bg-white shadow-2xl transform transition-all max-w-4xl w-full overflow-hidden max-h-[90vh] flex flex-col">
          ...
          <div className="relative px-8 py-5 bg-blue-950 text-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm">Update course information</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
            <div className="px-8 py-6">
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-6">Review Changes</h3>
