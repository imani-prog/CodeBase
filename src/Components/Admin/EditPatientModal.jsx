    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex items-center justify-center min-h-screen p-0 sm:p-4">
        <div className="relative bg-white shadow-2xl transform transition-all max-w-5xl w-full overflow-hidden h-screen sm:h-auto sm:max-h-[90vh] flex flex-col">
          ...
          {/* Tabs */}
          <div className="bg-white border-b border-gray-200 px-1 sm:px-8">
            <div className="flex">
              {tabs.map(tab => (
                <button
                  key={tab.id}
                  ...
                  title={tab.label}
                  className={`flex flex-col sm:flex-row items-center justify-center flex-1 sm:flex-none sm:px-4 py-2 sm:py-3 text-xs font-medium border-b-2 transition-colors gap-1 sm:gap-0 ${
                    activeTab === tab.id
