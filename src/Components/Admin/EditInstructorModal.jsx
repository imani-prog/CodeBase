...
const EditInstructorModal = ({ showModal, setShowModal, instructor, onUpdateInstructor }) => {
          ...
          <div className="relative px-8 py-5 bg-blue-950 text-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold mb-1">Edit Instructor</h2>
                <p className="text-sm">Update instructor information</p>
              </div>
            </div>
          </div>
