  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0H8m0 0v.01M8 6v12a2 2 0 002 2h4a2 2 0 002-2V6" />
          </svg>
        )
      },
    ],
...
const Navbar = () => {
  ...
  return (
   <nav className="sticky top-0 z-50 bg-blue-950 shadow-sm">
  <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
    {/* Logo */}
    <Link
      to="/"
      className="text-2xl font-bold text-white hover:text-yellow-300 tracking-tight"
    ...
    {/* Desktop Menu */}
    <div className="hidden md:flex items-center gap-6 text-[15px] text-white">
      <Link
        to="/"
        className="font-semibold hover:text-yellow-300 px-2 py-1 rounded transition duration-200"
      >
        Home
      </Link>
