          ...
          <div className="relative px-4 py-4 sm:px-8 sm:py-5 bg-blue-950 text-white flex-shrink-0">
            ...
            <div className="flex items-center gap-3 sm:gap-4 pr-10">
              ...
              <div className="min-w-0">
                <h2 className="text-lg sm:text-2xl font-bold leading-tight">New Appointment</h2>
                <p className="text-xs sm:text-sm opacity-80 mt-0.5">Schedule a visit with your patient</p>
              </div>
            </div>
          </div>
                      ...
                      <input
                        ...
                        placeholder={
                          form.type === 'Home Visit'
                            ...
                            : 'e.g. Community Health Center, Block A'
                        }
                        className={`w-full pl-9 pr-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent transition-all ${
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    placeholder="Any additional notes or instructions for this appointment…"
