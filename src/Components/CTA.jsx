...
const CTA = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className={`relative  p-8  transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-green-400/20 to-blue-400/20 rounded-full blur-2xl" />
        
        <div className="relative z-10">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
              <Shield className="w-8 h-8 text-blue-600" />
              <h3 className="text-3xl font-bold">Built for Africa, Backed by Security</h3>
            </div>
            <p className="text-gray-600 text-lg">Trusted by healthcare providers across Kenya</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {securityFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className={`bg-white/70 backdrop-blur-sm rounded-2xl p-6 border-2 transition-all duration-500 ${
                    isActive 
      ...
      {/* Main CTA Section */}
      <div className={` p-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* Animated background elements */}
        <div className="absolute top-0 left-1/4 w-20 h-20 bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-full blur-2xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-16 h-16 bg-gradient-to-br from-blue-400/30 to-cyan-400/30 rounded-full blur-xl animate-pulse delay-1000" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {supportFeatures.map((feature, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="group bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-lg hover:scale-105"
                  >
                    <div className="flex items-center justify-center space-x-3">
                      <div className="bg-green-100 group-hover:bg-green-200 rounded-full p-2 transition-colors duration-300">
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap justify-center gap-4">
              <button
                ...
                className="group relative bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 font-semibold overflow-hidden"
              >
              ...
              <button
                ...
                className="group relative bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 font-semibold overflow-hidden"
              >
            ...
            <button
              ...
              className="group bg-gradient-to-r from-green-100 to-blue-100 hover:from-green-200 hover:to-blue-200 text-gray-800 px-8 py-3 rounded-xl shadow-md transition-all duration-300 transform hover:scale-105 font-semibold border border-green-200 hover:border-green-300"
            >
              <div className="flex items-center space-x-2">
                <Globe className="w-5 h-5 text-green-600" />
                <span>See Hospital Success Stories</span>
