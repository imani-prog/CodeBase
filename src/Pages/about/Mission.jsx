...
const Mission = ({ compact = false }) => {
  return (
    <div className="mb-0 w-screen bg-blue-950 text-left relative text-white overflow-x-hidden mx-[calc(50%-50vw)]">
      ...
      <main className="flex flex-col items-center w-full px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10 max-w-[1200px] mx-auto">
        ...
        <section className="mb-6 sm:mb-8 md:mb-10 w-full grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 text-black">
          <div className="p-4 sm:p-5 md:p-6 flex flex-col items-start bg-blue-50 shadow-md sm:shadow-lg rounded-2xl sm:rounded-3xl border border-blue-200">
            ...
            <p className="text-sm sm:text-base md:text-lg leading-relaxed">
              {compact
                ? "Connecting communities, clinics, and caregivers through a smart platform for quality, affordable, timely care."
          ...
          <div className="p-4 sm:p-5 md:p-6 flex flex-col items-start bg-blue-50 shadow-md sm:shadow-lg rounded-2xl sm:rounded-3xl border border-blue-200">
            ...
            <p className="text-sm sm:text-base md:text-lg leading-relaxed">
              {compact
                ? "A healthy, empowered Africa with quality care anytime, anywhere."
              ...
              <div>
                ...
                {compact ? (
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed px-2">
                    We connect patients, providers, and CHWs to deliver timely, affordable, quality care across Africa.
                  </p>
                ) : (
                  <>
              ...
              <div className="w-full max-w-lg">
                ...
                <div className="mt-3 sm:mt-4 text-center px-2">
                  <p className="text-blue-200 text-xs sm:text-sm leading-relaxed">
                    {compact
                      ? "See how technology is improving care across Africa."
        ...
        <section className="mb-0 w-full text-left">
          ...
          <p className="text-sm sm:text-base md:text-lg text-center mb-6 sm:mb-7 md:mb-8 max-w-2xl mx-auto px-2 leading-relaxed">
            {compact
              ? "Our values guide how we serve communities across Africa."
              : "Our values drive every decision, every innovation, and every interaction. They shape the MediLink experience for communities, clinics, and caregivers across Africa."}
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto justify-center">
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Empathy and kindness in care." : "We put empathy and kindness at the heart of healthcare delivery."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Honesty and transparency." : "We uphold honesty, transparency, and ethical standards in all we do."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Care without barriers." : "We break barriers to ensure everyone can access quality care."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Creative, tech-driven solutions." : "We embrace creativity and technology to solve real-world health challenges."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Own results and impact." : "We take responsibility for our actions and measure our impact."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Communities lead their health." : "We enable communities to take charge of their health and future."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Everyone included." : "We celebrate diversity and ensure no one is left behind."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center transition">
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Data-driven decisions." : "We use data and research to guide our decisions and improve outcomes."}
              </span>
            </div>
            <div className="bg-blue-100 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-6 md:p-8 flex flex-col items-center transition">
              <span className="text-3xl sm:text-4xl mb-2 sm:mb-3"></span>
              ...
              <span className="text-center text-black text-xs sm:text-sm md:text-base leading-relaxed">
                {compact ? "Protecting people and planet." : "We commit to environmentally sustainable practices that protect our planet."}
              </span>
            </div>
          </div>
