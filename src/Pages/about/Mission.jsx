    ...
    <div className="mb-0 w-full bg-blue-950 text-left text-white">
      ...
      <main className="flex flex-col items-center w-full px-0 py-10 max-w-[1200px] mx-auto">
        <section className="w-full flex flex-col items-center">
          <h1 className="text-5xl font-extrabold mb-6 text-center leading-tight">Vision & Mission</h1>
        </section>
        <section className="mb-10 w-full grid grid-cols-1 md:grid-cols-2 gap-8 text-black">
          <div className="p-4 flex flex-col items-start bg-blue-50 shadow-lg rounded-3xl border border-blue-200">
            <h2 className="text-4xl font-extrabold text-blue-600 mb-2">Mission</h2>
          ...
          <div className="p-4 flex flex-col items-start bg-blue-50 shadow-lg rounded-3xl border border-blue-200">
            <h2 className="text-4xl font-extrabold text-blue-600 mb-2">Vision</h2>
        ...
        <section className="mb-10 w-full">
          <h2 className="text-3xl font-bold mb-8 text-center">Transforming African Healthcare</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            {/* Left side - Text Content */}
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-blue-200">Our Digital Revolution</h3>
              ...
              <div className="bg-blue-900/50 rounded-xl p-6">
                <h4 className="text-xl font-semibold mb-3 text-blue-200">Impact at a Glance</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">50K+</div>
                    <div className="text-sm text-blue-300">Patients Served</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">200+</div>
                    <div className="text-sm text-blue-300">Health Facilities</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">1000+</div>
                    <div className="text-sm text-blue-300">CHW Network</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">15+</div>
                    <div className="text-sm text-blue-300">Counties Reached</div>
                  </div>
                </div>
              </div>

              <div>
                <h4 className="text-xl font-semibold mb-3 text-blue-200">Key Features</h4>
        ...
        <section className="mb-0 w-full text-left">
          <h2 className="text-3xl font-extrabold mb-4 text-center">Core Values</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto justify-center">
            ...
            <div className="bg-blue-100 rounded-2xl shadow-lg p-8 flex flex-col items-center transition">
              <span className="text-4xl mb-3"></span>
              <span className="font-bold text-blue-800 text-xl mb-2">Sustainability</span>
