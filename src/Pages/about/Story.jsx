    ...
    <div className="min-h-screen w-full flex flex-col font-sans bg-blue-50">
      ...
      <main className="flex flex-col items-center w-full px-0 py-10 max-w-[1200px] mx-auto">
        <section className="w-full flex flex-col items-center">
          <h1 className="text-5xl font-extrabold text-blue-900 mb-3 text-center leading-tight font-serif">Our Story</h1>
        </section>


        <section className="mb-5 w-full bg-blue-50 p-4 text-left">
          <h2 className="text-3xl font-bold text-blue-800 mb-3 font-serif">Problem-Driven</h2>
        ...
        <section className="mb-2 w-full p-3 text-left">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="flex flex-col justify-between h-full">
              <h2 className="text-2xl font-bold text-blue-800 mb-2 font-serif">Why We Exist</h2>
              ...
              <div className="mt-2">
                <h3 className="text-xl font-bold text-blue-700 mb-2 font-serif">Our Impact</h3>
        ...
        <section className="w-full p-2 text-left">
          <div>
            <h3 className="text-xl font-bold text-blue-700 mb-2 font-serif">A Vision for the Future</h3>
