// Reusable testimonial block for Solutions pages
const SolutionTestimonial = ({ quote, name, role, location, avatar }) => (
  <div className="bg-blue-50 rounded-2xl shadow-lg border border-blue-200 p-6 flex flex-col items-center text-center space-y-3 mt-10">
    ...
    <blockquote className="italic text-blue-700 mb-2">"{quote}"</blockquote>
    <div className="font-semibold text-blue-800">{name}</div>
    <div className="text-blue-600 text-sm">{role}, {location}</div>
  </div>
);
