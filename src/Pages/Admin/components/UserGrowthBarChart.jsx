    ...
    <div className="bg-white shadow-sm p-6 border border-gray-100">
      ...
      <div className="flex items-center justify-center gap-6 mt-6 flex-wrap">
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.patients }}></div>
          <span className="text-sm text-gray-600">Patients</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.chws }}></div>
          <span className="text-sm text-gray-600">CHWs</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.doctors }}></div>
          <span className="text-sm text-gray-600">Doctors</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.admins }}></div>
          <span className="text-sm text-gray-600">Admins</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.hospitals }}></div>
          <span className="text-sm text-gray-600">Hospitals</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: COLORS.drivers }}></div>
